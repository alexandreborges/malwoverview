...
def hafilecheck(filenameha): 
    ...
    try:
        ...
        resource = {'file': (filenameha, open(filenameha, 'rb')), 'type': (None, 'application/octet-stream'), 'environment_id': (None, haenv)}
...
if __name__ == "__main__":
    ...
    parser = optparse.OptionParser("malwoverview "+"-d <directory> -f <fullpath> -i <0|1> -b <0|1> -v <0|1> -a <0|1> -p <0|1> -s <0|1> -x <0|1> -w <|1> -u <url> -H <hash file> -V <filename> -D <0|1> -e<0|1|2|3> -A <filename> -g <job_id> -r <domain>")
    ...
    parser.add_option('-e', dest='sysenviron', type='int',default = 0, help='(optional) This option specified the used environment to be used to test the samlple on Hybrid Analysis: <0> Windows 32-bits; <1> Windows 64-bits; <2> Android; <3> Linux 64-bits environment. This option is used together either -H option or the -A option.')
